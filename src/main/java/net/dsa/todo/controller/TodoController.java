...
public class TodoController {
	...
	public String todoList(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
						   Model model) {
		
		List<Todo> todoList = todoService.getTodoList(authenticatedUser.getUser());
	...
	public String addTodo(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
	...
	public String todoUpdate(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
		...
		if (todo.getUser().getId().equals(authenticatedUser.getUser().getId())) {
	...
	public String removeTodo(@AuthenticationPrincipal AuthenticatedUser authenticatedUser,
